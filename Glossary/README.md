# Siber Güvenlik Terimleri Sözlüğü (Siber Sözlük)
...
| Cyber attack  | Content Cell  | Siber yollarla bilgisayar sistemlerine, ağlara veya cihazlara zarar vermeye, bozmaya veya yetkisiz erişim sağlamaya yönelik girişimler.
| Denial of Service  DoS | Hizmet Reddi  |s
| Distributed Denial of Service  DDoS | Dağıtılmış Hizmet Reddi/ Ağ Saldırıları  |s
...
| Ransomware  | Fidye Yazılım  | Bulaştığı sistemdeki dosyaları şifreleyerek kurbandan belirli bir ücret karşılığında dosyaların çözümlenmesi için gereken şifreyi ileteceğini belirtir.[Ayrıca Bakınız](https://github.com/omerwwazap/Security-Awareness/tree/main/Malware%20Removal%20Guide#ransomware-decryption-and-identification-tools)
| Rootkit  | NO Translation  |  İşletim sisteminizden ve antivirüs yazılımınızdan kendini gizleyebilen bir kötü amaçlı yazılım türüdür. Rootkitlerin tespit edilmesi ve çıkarılması çok zordur. Sisteminizi her başlattığınızda, rootkit bir saldırgana sisteme sürekli kök düzeyinde erişim verir.
...
| Trojan  | Truva Atı (Zaralı yazılım)  |s
| Virus  | Content Cell  |s
| Water-holing   | Content Cell  |s
| Worm  | Content Cell  |s
| Zero-day  | Sıfırıncı Gün Açığı  |s
